...
def parse_arguments():
    ...
    parser.add_argument('-t', '--timeout', type=int, default=5, help='Timeout in seconds per request')
    ...
    parser.add_argument('--verify-delay', type=int, default=2, help='Delay between injection and verification in seconds')
